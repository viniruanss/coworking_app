export const swaggerDocument = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Documentação da API do sistema de gestão de coworking. Permite gerenciar usuários, salas e reservas, com autenticação via JWT e soft lock para prevenção de condição de corrida em reservas.",
  },
  servers: [
    {
